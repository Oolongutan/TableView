...
struct TeaInfo {
    ...
    //Names and types of teas for table and for the title of the explanation page.
    //All teas are from Jasmine Pearl, please do not use for anything other than class.
    var teas = [
    ...
    //Explanations of teas for second page. Also from Jasmine Pearl.
    var blurbs = [
